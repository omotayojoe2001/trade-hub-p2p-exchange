...
const SellCryptoDispute = () => {
  ...
  const handleSubmitDispute = () => {
    ...
    console.log("Sell dispute submitted:", disputeData);
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-red-700">
                  Our team will review your case and help resolve the issue. Your crypto will remain in escrow until resolved.
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="space-y-3">
              <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  Upload bank statements, screenshots, or other evidence
                </p>
                <Input
                  type="file"
                  multiple
          ...
          <CardContent className="p-4">
            <div className="text-sm">
              ...
              <ul className="text-muted-foreground space-y-1">
                <li>• Your crypto remains safely in escrow</li>
                <li>• Our support team will investigate the issue</li>
                <li>• We'll contact the buyer for their side of the story</li>
                <li>• You'll receive updates via notifications</li>
                <li>• Most disputes are resolved within 24-48 hours</li>
              </ul>
            </div>
          </CardContent>
        </Card>
...
export default SellCryptoDispute;