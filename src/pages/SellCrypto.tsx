        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full text-4xl font-light text-gray-400 bg-transparent border-none outline-none"
              placeholder="0.00"
            />
          ...
          <div className="mt-4">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-500">Rate: ₦750,000/BTC</span>
          ...
          <div className="space-y-3">
            <div 
              className={`p-4 rounded-lg border-2 cursor-pointer ${
                selectedPayment === 'bank' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
              }`}
