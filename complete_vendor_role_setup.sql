-- COMPLETE VENDOR ROLE SETUP - FIXES ALL AUTHENTICATION ISSUES
-- Run this to fix vendor login access denied errors
...
-- 6. Update/Insert vendor profiles with BOTH user_type AND role
INSERT INTO profiles (user_id, display_name, phone_number, location, bio, user_type, role, is_vendor) 
VALUES ('053d8388-9fed-4827-8e7e-9cd6bb77e95c', 'Ikeja Vendor Agent', '+234 801 234 5678', 'Ikeja, Lagos', 'Cash delivery agent for Ikeja area', 'vendor', 'vendor', true)
...
INSERT INTO profiles (user_id, display_name, phone_number, location, bio, user_type, role, is_vendor) 
VALUES ('4233b8b1-5bc4-4373-a599-69930ab79863', 'Island Vendor Agent', '+234 801 234 5679', 'Lagos Island', 'Cash delivery agent for Island area', 'vendor', 'vendor', true)
ON CONFLICT (user_id) DO UPDATE SET
    display_name = EXCLUDED.display_name,
    phone_number = EXCLUDED.phone_number,
    location = EXCLUDED.location,
...
INSERT INTO profiles (user_id, display_name, phone_number, location, bio, user_type, role, is_vendor) 
VALUES ('ce474c61-0d72-4d99-9068-cd508421e6ad', 'Lekki Vendor Agent', '+234 801 234 5680', 'Lekki, Lagos', 'Cash delivery agent for Lekki area', 'vendor', 'vendor', true)
ON CONFLICT (user_id) DO UPDATE SET
    display_name = EXCLUDED.display_name,
    phone_number = EXCLUDED.phone_number,
    location = EXCLUDED.location,
...
-- 8. Create vendor entries with address field
...
-- Success message
SELECT 'Complete vendor setup with role authentication completed!' as result;