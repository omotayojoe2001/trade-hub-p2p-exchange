-- Fix the tracking_code ambiguity in create_cash_order_with_vendor function
DROP FUNCTION IF EXISTS public.create_cash_order_with_vendor(uuid, numeric, numeric, numeric, text, jsonb, jsonb);
