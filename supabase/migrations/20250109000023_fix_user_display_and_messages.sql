-- Fix user display name function and vendor_messages relationship
...
-- 3. Fix vendor_messages table - add foreign key to profiles if it doesn't exist
ALTER TABLE vendor_messages DROP CONSTRAINT IF EXISTS vendor_messages_sender_id_fkey;
ALTER TABLE vendor_messages ADD CONSTRAINT vendor_messages_sender_id_fkey 
